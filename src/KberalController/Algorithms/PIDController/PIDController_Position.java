...
public class PIDController_Position {

    public double kp, ki, kd;      //PID系数
    public double err_sum;         //误差积分
    public double err_last;        //上次误差
    ...
    /*
        ...
        输入：p系数，i系数，d系数
     */
    public PIDController_Position(double kp, double ki, double kd) {
        //设定PID系数
     ...
     */
    public PIDController_Position(double kp, double ki, double kd, double p_max, double i_max, double d_max) {
        //设定PID系数
        update_parameter(kp, ki, kd);
        //设定计算最大值
     ...
     */
    public PIDController_Position(double kp, double ki, double kd, double p_max, double i_max, double d_max, double out_min, double out_max, double bias) {
        //设定PID系数
        update_parameter(kp, ki, kd);
        //设定计算最大值
        set_pidMaxValue(p_max, i_max, d_max);
    ...
    public double calc_pid(double set, double actual) {
        ...
        double err = set - actual;          //误差

        //P控制
        double p = err * kp;                //比例控制
